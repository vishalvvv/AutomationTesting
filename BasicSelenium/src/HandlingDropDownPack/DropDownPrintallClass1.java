...
public class DropDownPrintallClass1 {
	...
	public static void main(String[] args) {
		...
		List<WebElement> ddcount = DD.findElements(By.tagName("option"));
		

		System.out.println("The total number of elements in the Drop Down are: " +ddcount.size());
		
		for(int h=0;h<ddcount.size();h++) {
			System.out.println(ddcount.get(h).getText());
		}

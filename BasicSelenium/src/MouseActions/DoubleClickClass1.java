...
public class DoubleClickClass1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("file:///C:/Users/Vishal/Downloads/Testing%20Tools/Automation%20Testing/basic%20selenium/Selenium%20Elements/Doubleclick.html");
		
		Thread.sleep(3000);
		
		WebElement W = driver.findElement(By.id("demo"));
		Actions H = new Actions(driver);
		H.doubleClick(W).perform();

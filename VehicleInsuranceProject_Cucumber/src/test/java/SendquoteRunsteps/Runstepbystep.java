...
public class Runstepbystep {
 ...
 public void userentersvehicledata() throws InterruptedException {
...
Select snoofseats = new Select(noofseats);
 ...
 @When("user enters the product details")
 ...
 @When("clicks on next button to go to price option page")
 public void clicksonnextbuttontogotopriceoptionpage() {
 ...
 public void thepriceoptionpageshoulddisplaytheavailablepricescorrectly() {
		WebElement goldOption = driver.findElement(By.id("selectgold"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click();", goldOption);
 ...
 public void usersentersendquotedetails()  {
	 driver.findElement(By.xpath("//input[@id='email']")).sendKeys("john@example.com");
	 driver.findElement(By.xpath("//input[@id='phone']")).sendKeys("456824278");
	 driver.findElement(By.xpath("//input[@id='username']")).sendKeys("johndoe");

...
public class Scripting  extends ReusedMethods{
		 ...
		 WebElement make =driver.findElement(By.xpath(obj.getProperty("XMAKE")));
            ...
            WebElement noofseats= driver.findElement(By.xpath(obj.getProperty("XNOOFSEATS")));
						...
						driver.findElement(By.xpath(obj.getProperty("XWEIGHT"))).sendKeys("1000");
					 	...
					 	screenshot("before Vehicle Data");
					 //	driver.findElement(By.xpath(obj.getProperty("XNEXTINSURANTDATA"))).click();
					 	WebElement idclick = new WebDriverWait(driver, Duration.ofSeconds(20))
					 	        .until(ExpectedConditions.elementToBeClickable(By.xpath(obj.getProperty("XNEXTINSURANTDATA"))));
                    	idclick.click();
					 	screenshot("After Vehicle Data");
	 }
	 
	 public void insurantData() throws IOException {
		 ...
		 driver.findElement(By.xpath(obj.getProperty("XLASTNAME"))).sendKeys("Doe");
           ...
           WebElement occupations = driver.findElement(By.xpath(obj.getProperty("XOCCUPATIONS")));
			...
			salloccupation.selectByVisibleText("Employee");
			 ...
			 screenshot("before Insurant Data");
		//	 driver.findElement(By.xpath(obj.getProperty("XENTERNEXTPRODUCTDATA"))).click();
				WebElement nextprodclick = new WebDriverWait(driver, Duration.ofSeconds(20))
			 	        .until(ExpectedConditions.elementToBeClickable(By.xpath(obj.getProperty("XENTERNEXTPRODUCTDATA"))));
            	nextprodclick.click();
			 screenshot("After Insurant Data");
			}
     ...
     WebElement Courtesycars = driver.findElement(By.xpath(obj.getProperty("XCOURTESYCARS")));
		   ...
		   screenshot("Before Product Data");
		//   driver.findElement(By.xpath(obj.getProperty("XNEXTPRODUCTBUTTON"))).click();
		   WebElement nextprodclick = new WebDriverWait(driver, Duration.ofSeconds(20))
		 	        .until(ExpectedConditions.elementToBeClickable(By.xpath(obj.getProperty("XNEXTPRODUCTBUTTON"))));
       	nextprodclick.click();
		   screenshot("After Product Data");
		   }
	...
	//	 driver.findElement(By.xpath("//button[@id='nextsendquote']")).click();
	 ...
	 public void sendQuote() throws IOException, InterruptedException{
		 ...
		 screenshot("Before Send Quote");
	//	 driver.findElement(By.xpath(obj.getProperty("XSENDEMAIL"))).click();
		 WebElement nextsendemailclick = new WebDriverWait(driver, Duration.ofSeconds(20))
		 	        .until(ExpectedConditions.elementToBeClickable(By.xpath(obj.getProperty("XSENDEMAIL"))));
    	nextsendemailclick.click();
    	Thread.sleep(40000);
		 screenshot("After Send Quote");
	 }

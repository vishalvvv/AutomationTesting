...
public class ExplicitlyClass2 {
  ...
  public void f() {
	  ...
	  WebElement L = new WebDriverWait(driver,Duration.ofSeconds(17)).until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@value ='Logi']")));

...
public class AndClass1 {
  ...
  public void xpath() {
	  ...
	  driver = new ChromeDriver();
		...
		driver.findElement(By.xpath("//input[@class= 'loginText' and @type='text']")).sendKeys("selenium");
		driver.findElement(By.xpath("//input[@class= 'loginText' and @type= 'password']")).sendKeys("cypress");
